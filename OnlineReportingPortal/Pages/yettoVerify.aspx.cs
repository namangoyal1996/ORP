...
public partial class Pages_yettoVerify : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ArrayList reportList = new ArrayList();

        reportList = ConnectionClass.Getyettoverify((int)Session["userid"]);
        foreach (Report report in reportList)
        {
          ...
          //  if (report.status != "Verified" && report.status != "Pending" && (string)Session["userlevel"] == "District")
